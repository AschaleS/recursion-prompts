...
var reverseArr = function(array) {
  ...
  var result = reverseArr(array.slice(0, array.length-1));
...
var replaceKeysInObj = function(obj, oldKey, newKey) {
  for (var val in obj){
    ...
    if(obj[val] instanceof Object){
      replaceKeysInObj(obj[val], oldKey, newKey);
    }
 }
 return obj;
};
...
var capitalizeFirst = function(array) {
  ...
  result.unshift((array[0].charAt(0).toUpperCase()) + array[0].slice(1));
...
var numToText = function(str) {
  ...
  if (numToTextObj[str[0]]) {
    return numToTextObj[str[0]] + numToText(str.slice(1));
  }
...
var mergeSort = function(array) {
  ...
  var result = mergeSort(array.slice(1));
  if(array[0] < result[0]){
    result.unshift(array[0]);
  }
  return result.sort();
